...
var ASM_CONSTS = {
 ...
 295980: ($0) => { miniaudio.untrack_device_by_index($0); },  
 296023: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 296148: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 296274: () => { if (document.fullscreenElement) return 1; },  
 296320: () => { return document.getElementById('canvas').width; },  
 296372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 296440: () => { document.exitFullscreen(); },  
 296467: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 296540: () => { if (document.fullscreenElement) return 1; },  
 296586: () => { return document.getElementById('canvas').width; },  
 296638: () => { return screen.width; },  
 296663: () => { document.exitFullscreen(); },  
 296690: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 296823: () => { return window.innerWidth; },  
 296849: () => { return window.innerHeight; },  
 296876: () => { if (document.fullscreenElement) return 1; },  
 296922: () => { return document.getElementById('canvas').width; },  
 296974: () => { return parseInt(document.getElementById('canvas').style.width); },  
 297042: () => { if (document.fullscreenElement) return 1; },  
 297088: () => { return document.getElementById('canvas').width; },  
 297140: () => { return screen.width; },  
 297165: () => { return window.innerWidth; },  
 297191: () => { return window.innerHeight; },  
 297218: () => { if (document.fullscreenElement) return 1; },  
 297264: () => { return document.getElementById('canvas').width; },  
 297316: () => { return screen.width; },  
 297341: () => { document.exitFullscreen(); },  
 297368: () => { if (document.fullscreenElement) return 1; },  
 297414: () => { return document.getElementById('canvas').width; },  
 297466: () => { return parseInt(document.getElementById('canvas').style.width); },  
 297534: () => { document.exitFullscreen(); },  
 297561: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 297619: () => { return screen.width; },  
 297644: () => { return screen.height; },  
 297670: () => { return window.screenX; },  
 297697: () => { return window.screenY; },  
 297724: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 297777: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 297848: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 297905: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 298161: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 298232: () => { if (document.fullscreenElement) return 1; },  
 298278: () => { return window.innerWidth; },  
 298304: () => { return window.innerHeight; },  
 298331: () => { if (document.pointerLockElement) return 1; }
};
